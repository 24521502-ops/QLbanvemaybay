...
public class AppColor {
    ...
    // MÀU THƯƠNG HIỆU (BRAND COLORS) - Dựa trên nút "Lưu thông tin", "In vé" và tone màu hàng không (SkyBlue/Teal)
    ...
    // MÀU NỀN & BỀ MẶT (BACKGROUND & SURFACE) - Nền ứng dụng và các Card trắng chứa bảng dữ liệu
    ...
    // MÀU TRẠNG THÁI (SEMANTIC COLORS) - Dựa trên các Tag trạng thái trong quản lý chuyến bay/đặt chỗ
