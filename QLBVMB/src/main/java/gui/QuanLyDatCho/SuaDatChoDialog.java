...
public class SuaDatChoDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        header.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, new Color(226, 232, 240)), new EmptyBorder(15, 25, 15, 25)));
        ...
        JLabel lblBookingInfo = new JLabel("<html><font color='#64748b' face='Inter' size='3'>MÃ ĐẶT CHỖ</font><br><font color='#0f172a' face='Inter' size='5'><b>" + bookingID + "</b></font></html>");
        lblTicketInfo = new JLabel("<html><font color='#64748b' face='Inter' size='3'>MÃ VÉ THAO TÁC</font><br><font color='#e11d48' face='Inter' size='5'><b>Đang tải...</b></font></html>");
    ...
    private void loadDataCuaBooking() {
        ...
        if (ticketID != null && !ticketID.isEmpty()) {
            lblTicketInfo.setText("<html><font color='#64748b' face='Inter' size='3'>MÃ VÉ THAO TÁC</font><br><font color='#e11d48' face='Inter' size='5'><b>" + ticketID + "</b></font></html>");
            lblTicketInfo.putClientProperty("TicketID", ticketID); // Lưu ngầm ID để xử lý
        } else {
            lblTicketInfo.setText("<html><font color='#64748b' face='Inter' size='3'>MÃ VÉ THAO TÁC</font><br><font color='#e11d48' face='Inter' size='5'><b>Lỗi / Trống</b></font></html>");
        }
    ...
    private void loadGheTrong(String flightID) {
        ...
        if (danhSachGhe.isEmpty()) {
            ...
            for (String g : danhSachGhe) cbxGheMoi.addItem(g);
        }
    }
    ...
    private void xuLyDoiVe() {
        ...
        if (ticketID == null) {
            JOptionPane.showMessageDialog(this, "Lỗi: Không tìm thấy Mã Vé hợp lệ để đổi!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (cbxChuyenBayMoi.getSelectedItem() == null || cbxGheMoi.getSelectedItem() == null || cbxGheMoi.getSelectedItem().toString().equals("Hết ghế trống!")) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn Chuyến bay mới và Ghế trống hợp lệ!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (success) {
            JOptionPane.showMessageDialog(this, "Đổi vé thành công! Tổng tiền đã được hệ thống tự động cập nhật.", "Hoàn tất", JOptionPane.INFORMATION_MESSAGE);
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Đổi vé thất bại! Ghế có thể đã có người đặt, vui lòng thử lại.", "Lỗi Database", JOptionPane.ERROR_MESSAGE);
        }
    }
