...
public class SuaKhachHangDialog extends JDialog {
    ...
    private void saveChanges() {
        ...
        if(success) { 
            ...
            JOptionPane.showMessageDialog(this, "Cập nhật thất bại. Vui lòng kiểm tra lại hệ thống.", "Lỗi CSDL", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private JButton makeCustomButton(String text, Color bgColor, Color fgColor) {
        ...
        btn.setPreferredSize(new Dimension(140, 40)); return btn;
    }
}