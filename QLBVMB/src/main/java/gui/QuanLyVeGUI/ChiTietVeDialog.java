...
public class ChiTietVeDialog extends JDialog {
    ...
    private void initComponents(String ticketID) {
        ...
        if (ticketInfo == null) {
            ...
            ticketInfo = new Object[] { "N/A", "N/A", "Hành khách", "Hạng", "0", "N/A", "N/A", "SGN", "HAN", "VN000",
                    "Ngày", "00:00", "00:00", "00", "N/A" };
        }
        ...
        JLabel lblBrand = new JLabel("TIU AIRLINES");
        lblBrand.setFont(new Font("Inter", Font.BOLD, 18));
        lblBrand.setForeground(BRAND_BLUE);
        // Lấy tên hãng bay thật từ cột AirlineName trong DB (là vị trí số 6) và in hoa
        // lên
        ...
        txtLogoWrap.add(lblBrand);
        txtLogoWrap.add(lblSubBrand);
        ...
        lblFrom.setFont(new Font("Inter", Font.BOLD, 52));
        lblFrom.setForeground(new Color(15, 23, 42));
        JLabel lblTo = new JLabel(ticketInfo[8].toString());
        lblTo.setFont(new Font("Inter", Font.BOLD, 52));
        lblTo.setForeground(new Color(15, 23, 42));

        JLabel lblIcon = new JLabel(" ─────── ✈ ─────── ", SwingConstants.CENTER);
        lblIcon.setFont(new Font("Inter", Font.PLAIN, 20));
        lblIcon.setForeground(BRAND_BLUE);
        ...
        // Số vé
        JPanel pnlTicketId = createInfoBlock("SỐ VÉ (TICKET ID)", ticketInfo[0].toString(),
        ...
        try {
            ...
            if (!f.exists())
                path = "D:\\HK2 2025-2026\\IS216-Lap Trinh Java\\QLbanvemaybay\\QLBVMB\\src\\main\\resources\\image\\qr.jpg";
            ...
            if (icon.getIconWidth() > 0) {
                ...
                JLabel lblError = new JLabel("LỖI ẢNH", SwingConstants.CENTER);
