...
public class VeDAO {
    ...
    // ĐÃ SỬA: Gọi Procedure SP_CANCEL_TICKET_FINAL để hủy vé, tính tiền hoàn và lưu
    // lịch sử
    ...
    public Object[] layThongTinChiTietVe(String ticketID) {
        ...
        String sql = "SELECT "
                ...
                + "TO_CHAR(FUNC_CALCULATE_BOARDING_TIME(f.FlightID), 'HH24:MI') AS GioLenMayBay, " // <-- Gọi Function
                                                                                                   // Oracle
