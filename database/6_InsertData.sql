...
/* =========================================================
   ...
   ========================================================= */
-- ==========================================================
-- [THÊM MỚI] MOCK DATA TƯƠNG LAI ĐỂ TÌM KIẾM VÀ DASHBOARD
-- ==========================================================
INSERT ALL
    INTO FLIGHT (FlightID, FlightNumber, AirlineID, AircraftID, RouteID, DepartureTime, ArrivalTime, Gate, FlightStatus) VALUES ('FL31', 'VN310', 'AL01', 'AC01', 'RT21', SYSDATE + 1, SYSDATE + 1 + 2/24, '01', 'SCHEDULED')
    INTO FLIGHT (FlightID, FlightNumber, AirlineID, AircraftID, RouteID, DepartureTime, ArrivalTime, Gate, FlightStatus) VALUES ('FL32', 'VN311', 'AL01', 'AC01', 'RT10', SYSDATE + 3, SYSDATE + 3 + 2/24, '02', 'SCHEDULED')
    INTO FLIGHT (FlightID, FlightNumber, AirlineID, AircraftID, RouteID, DepartureTime, ArrivalTime, Gate, FlightStatus) VALUES ('FL33', 'VJ330', 'AL02', 'AC07', 'RT05', SYSDATE + 2, SYSDATE + 2 + 1/24, '03', 'SCHEDULED')
    INTO FLIGHT (FlightID, FlightNumber, AirlineID, AircraftID, RouteID, DepartureTime, ArrivalTime, Gate, FlightStatus) VALUES ('FL34', 'VJ331', 'AL02', 'AC07', 'RT19', SYSDATE + 4, SYSDATE + 4 + 3/24, '04', 'SCHEDULED')
SELECT 1 FROM DUAL;

INSERT ALL
    INTO SEATCLASSPRICE (PriceID, FlightID, Class, Price) VALUES ('FL31_1', 'FL31', 'Economy', 2500000)
    INTO SEATCLASSPRICE (PriceID, FlightID, Class, Price) VALUES ('FL31_2', 'FL31', 'Business', 4500000)
    INTO SEATCLASSPRICE (PriceID, FlightID, Class, Price) VALUES ('FL32_1', 'FL32', 'Economy', 2600000)
    INTO SEATCLASSPRICE (PriceID, FlightID, Class, Price) VALUES ('FL32_2', 'FL32', 'Business', 4800000)
    INTO SEATCLASSPRICE (PriceID, FlightID, Class, Price) VALUES ('FL33_1', 'FL33', 'Economy', 1500000)
    INTO SEATCLASSPRICE (PriceID, FlightID, Class, Price) VALUES ('FL34_1', 'FL34', 'Economy', 3500000)
SELECT 1 FROM DUAL;

-- BOOKINGS
INSERT ALL
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK901', 'CUS01', 'EMP04', SYSDATE - 5, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK902', 'CUS02', 'EMP05', SYSDATE - 2, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK903', 'CUS03', 'EMP04', SYSDATE, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK904', 'CUS04', 'EMP04', SYSDATE - 1, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK905', 'CUS05', 'EMP05', SYSDATE - 1, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK906', 'CUS06', 'EMP04', SYSDATE - 2, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK907', 'CUS07', 'EMP05', SYSDATE - 2, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK908', 'CUS08', 'EMP04', SYSDATE, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK909', 'CUS09', 'EMP04', SYSDATE - 3, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK910', 'CUS10', 'EMP05', SYSDATE - 1, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK911', 'CUS11', 'EMP04', SYSDATE - 2, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK912', 'CUS12', 'EMP05', SYSDATE, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK913', 'CUS13', 'EMP04', SYSDATE - 4, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK914', 'CUS14', 'EMP05', SYSDATE - 2, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK915', 'CUS15', 'EMP04', SYSDATE - 1, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK916', 'CUS16', 'EMP05', SYSDATE - 3, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK917', 'CUS17', 'EMP04', SYSDATE - 5, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK918', 'CUS18', 'EMP05', SYSDATE - 2, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK919', 'CUS19', 'EMP04', SYSDATE - 1, 'CONFIRMED', 0)
    INTO BOOKING (BookingID, CustomerID, EmployeeID, BookingDate, Status, TotalAmount) VALUES ('BK920', 'CUS20', 'EMP05', SYSDATE, 'CONFIRMED', 0)
SELECT 1 FROM DUAL;

-- TICKETS
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK901', 'BK901', 'FL01', 'AC03_1', 'PA001', 2500000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK902', 'BK902', 'FL31', 'AC01_1', 'PA002', 4500000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK903', 'BK903', 'FL32', 'AC01_2', 'PA003', 2600000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK904', 'BK903', 'FL32', 'AC01_3', 'PA004', 2600000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK905', 'BK904', 'FL31', 'AC01_2', 'PA005', 2500000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK906', 'BK904', 'FL31', 'AC01_3', 'PA006', 2500000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK907', 'BK905', 'FL32', 'AC01_4', 'PA007', 2600000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK908', 'BK905', 'FL32', 'AC01_5', 'PA008', 2600000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK909', 'BK906', 'FL33', 'AC07_1', 'PA009', 1500000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK910', 'BK907', 'FL34', 'AC07_1', 'PA010', 3500000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK911', 'BK908', 'FL01', 'AC03_2', 'PA011', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK912', 'BK908', 'FL01', 'AC03_3', 'PA012', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK913', 'BK909', 'FL03', 'AC06_2', 'PA013', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK914', 'BK910', 'FL04', 'AC10_1', 'PA014', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK915', 'BK910', 'FL04', 'AC10_2', 'PA015', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK916', 'BK911', 'FL05', 'AC15_1', 'PA016', 5000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK917', 'BK912', 'FL08', 'AC07_2', 'PA017', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK918', 'BK913', 'FL11', 'AC05_1', 'PA018', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK919', 'BK913', 'FL11', 'AC05_2', 'PA019', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK920', 'BK914', 'FL14', 'AC13_1', 'PA020', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK921', 'BK915', 'FL16', 'AC01_6', 'PA021', 4000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK922', 'BK916', 'FL17', 'AC11_1', 'PA022', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK923', 'BK916', 'FL17', 'AC11_2', 'PA023', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK924', 'BK917', 'FL19', 'AC08_1', 'PA024', 3000000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK925', 'BK918', 'FL31', 'AC01_7', 'PA025', 4500000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK926', 'BK919', 'FL32', 'AC01_8', 'PA026', 2600000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK927', 'BK919', 'FL32', 'AC01_9', 'PA027', 2600000, 'PAID');
    INSERT INTO TICKET (TicketID, BookingID, FlightID, SeatID, PassengerID, Price, TicketStatus) VALUES ('TK928', 'BK920', 'FL34', 'AC07_3', 'PA028', 3500000, 'PAID');
-- PAYMENTS
INSERT ALL
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM901', 'BK901', SYSDATE - 5, 2500000, 'CREDIT CARD', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM902', 'BK902', SYSDATE - 2, 4500000, 'BANK TRANSFER', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM903', 'BK903', SYSDATE, 5200000, 'MOMO', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM904', 'BK904', SYSDATE - 1, 5000000, 'CREDIT CARD', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM905', 'BK905', SYSDATE - 1, 5200000, 'BANK TRANSFER', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM906', 'BK906', SYSDATE - 2, 1500000, 'MOMO', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM907', 'BK907', SYSDATE - 2, 3500000, 'CREDIT CARD', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM908', 'BK908', SYSDATE, 6000000, 'MOMO', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM909', 'BK909', SYSDATE - 3, 3000000, 'CREDIT CARD', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM910', 'BK910', SYSDATE - 1, 6000000, 'BANK TRANSFER', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM911', 'BK911', SYSDATE - 2, 5000000, 'MOMO', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM912', 'BK912', SYSDATE, 3000000, 'CREDIT CARD', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM913', 'BK913', SYSDATE - 4, 6000000, 'MOMO', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM914', 'BK914', SYSDATE - 2, 3000000, 'BANK TRANSFER', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM915', 'BK915', SYSDATE - 1, 4000000, 'CREDIT CARD', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM916', 'BK916', SYSDATE - 3, 6000000, 'MOMO', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM917', 'BK917', SYSDATE - 5, 3000000, 'CREDIT CARD', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM918', 'BK918', SYSDATE - 2, 4500000, 'BANK TRANSFER', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM919', 'BK919', SYSDATE - 1, 5200000, 'MOMO', 'SUCCESS')
    INTO PAYMENT (PaymentID, BookingID, PaymentDate, Amount, PaymentMethod, PaymentStatus) VALUES ('PM920', 'BK920', SYSDATE, 3500000, 'CREDIT CARD', 'SUCCESS')
SELECT 1 FROM DUAL;
